    ...
    <div className="contact-form">
        ...
        <form>
            ...
            <div className="form-group pt-lg-2 pt-3"> <label htmlFor="name">Your Name</label> <input type="text" name="name" className="form-control" required /> </div>
                <div className="form-group pt-lg-2 pt-3"> <label htmlFor="email">Your Name</label> <input type="email" name="email" className="form-control" required /> </div>
                
                 <label htmlFor="message">Message</label> <textarea name="message" className="form-control" required></textarea> </div>
