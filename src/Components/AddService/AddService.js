        ...
        <div className="container mx-auto my-5">
            ...
            <div className="wrapper rounded d-flex align-items-stretch">
                ...
                <div className="contact-form">
                    <div className="h2 text-center">Add A Travel Place</div>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-group pt-3"> <label htmlFor="desc">A Description</label> <textarea name="desc"  {...register("desc")}  className="form-control" required ></textarea> </div>
                        
                        <div className="d-flex align-items-center flex-wrap justify-content-center pt-lg-5 mt-lg-4 mt-5">
